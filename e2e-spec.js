...
describe("Portfolio Project Tests", function () {
  describe("Menu Toggle", function () {
    it("should toggle menu classes on click", function () {
      const dom = new JSDOM(
        `<!DOCTYPE html><body><div class="menu-btn"></div><div class="menu"></div><div class="menu-nav"></div><div class="menu-branding"></div><div class="nav-item"></div></body>`,
  ...
  describe("Blog Pagination", function () {
    it("should paginate blog posts correctly", function () {
      ...
      const blogData = [
        ...Array(13)
          .fill()
          .map((_, i) => ({ title: `Post ${i + 1}`, content: "..." })),
      ];
